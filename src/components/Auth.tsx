    ...
    <>
      <div className='w-screen h-halfscreen flex flex-col flex-nowrap, items-center justify-center'>
        <div className='h-halfscreen flex flex-col flex-nowrap justify-center'>
          <h1 className='mb-0 mt-5 text-3xl font-bold'>Kansha</h1>
          <p className='my-4'>
          ...
          <div>
            ...
            <button className='h-10 m-auto w-64 p-2 cursor-pointer flex items-center justify-center bg-dark text-light rounded' onClick={signInWithGoogle}>
